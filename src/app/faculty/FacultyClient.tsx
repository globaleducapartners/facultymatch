    ...
    <div style={{ background: C.paper, fontFamily: SANS }}>
      ...
      <section style={{
        ...
        <div style={{
          ...
          minHeight: "inherit",
          textAlign: "center",
          padding: isMob ? "60px 20px" : "0 40px",
        }}>
          ...
          <h1 style={{ fontFamily: SERIF, fontSize: isMob ? 34 : 54, fontWeight: 400, color: "#fff", lineHeight: 1.1, letterSpacing: "-0.025em", margin: "0 0 20px", maxWidth: 680 }}>
      ...
      <section style={{ background: C.cream }}>
        <div style={{ padding: pad, maxWidth: 1080, margin: "0 auto" }}>
          <div style={{ display: "grid", gridTemplateColumns: isMob ? "1fr" : "1fr 1fr", gap: isMob ? 0 : 60, alignItems: "center" }}>
