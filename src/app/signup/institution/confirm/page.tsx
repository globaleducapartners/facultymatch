      ...
      <div style={{ width: "100%", maxWidth: 440 }}>
        ...
        <div style={{
          ...
          <div style={{ textAlign: "center" }}>
            ...
            {email && (
              <p style={{
                ...
                color: D.navy, margin: "8px 0 0", wordBreak: "break-all" as const,
              }}>
                {email}
              </p>
            )}
          ...
          <div style={{
            ...
            <p style={{ fontFamily: SANS, fontSize: 13, fontWeight: 600, color: D.navy, margin: "0 0 4px" }}>
              Acceso inmediato al directorio
            </p>
            <p style={{ fontFamily: SANS, fontSize: 12, color: D.muted, margin: 0, lineHeight: 1.5 }}>
              Una vez confirmada la cuenta, podrás empezar a buscar docentes verificados desde tu panel institucional. No tendrás que rellenar nada más.
            </p>
          </div>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 10 }}>
            ...
            <p style={{ fontFamily: SANS, fontSize: 12, color: D.muted, textAlign: "center" as const, margin: 0 }}>
              <Link href="/signup/institution" style={{ color: D.muted, textDecoration: "underline" }}>
                ¿Email incorrecto? Volver al registro
              </Link>
            </p>

            <Link href="/login" style={{
              fontFamily: SANS, display: "block", textAlign: "center" as const,
